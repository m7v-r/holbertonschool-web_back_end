...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        Get page from dataset based on page and page_size parameters.
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict[str, Any]:
        """
        Get hypermedia pagination metadata dictionary.
        ...
        Returns:
            Dict[str, Any]: Dictionary containing pagination metadata.
        """
